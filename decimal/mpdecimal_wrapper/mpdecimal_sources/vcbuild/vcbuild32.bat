...
copy /y libmpdec-2.4.2.lib ..\vcbuild\dist32
...
copy /y libmpdec-2.4.2.dll ..\vcbuild\dist32
copy /y libmpdec-2.4.2.dll.lib ..\vcbuild\dist32
copy /y libmpdec-2.4.2.dll.exp ..\vcbuild\dist32
